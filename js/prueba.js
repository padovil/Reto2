    ...
    $.ajax(
        {
            ...
            success: function (json) {
                ...
                $("#idDivConsulta").append('<table id="tblConsulta" class="table table-bordered table-hover textColor" style="width: 100%"><tr style="font-weight: bold;background-color: #04aa6d;color: white;text-align: center;"><th class="bold">ID</th><th class="bold">BRAND</th><th class="bold">MODEL</th><th class="bold">CATEGORY ID</th><th class="bold">NAME</th><th class="bold"> </th><th class="bold"> </th></tr></table>');

                for (i = 0; i < json.items.length; i++) {
                    $("#idDivConsulta").append('<table id="tblConsulta" class="table table-bordered table-hover textColor" style="width: 100%"><tr><tr><td><div class="tabla"><a class="ver" href="javascript:;" onclick="consultarId(' + json.items[i].id + ')"> ' + json.items[i].id + ' </a></div></td><td><div class="tabla">' + json.items[i].brand + '</div></td><td><div class="tabla">' + json.items[i].model + '</div></td><td><div class="tabla">' + json.items[i].category_id + '</div></td><td><div class="tabla">' + json.items[i].name + '</div></td><td><div class="tabla"><a type=button href="javascript:borrar(' + json.items[i].id + ')"> <img src="https://cdn.icon-icons.com/icons2/868/PNG/128/trash_bin_icon-icons.com_67981.png" width="40" height="40"> </a></div></td><td><div class="tabla"><a type=button href="javascript:modificar()"> <img src="https://image.flaticon.com/icons/png/512/104/104668.png" width="40" height="40"> </a></div></td></tr></table>');
                }
    ...
    $.ajax(
        {
            ...
            success: function (json) {
                ...
                $("#idDivConsulta").append('<a type=button class="modificar" href="javascript:modificar()">Actualizar</a>');
